...
public class Listeners implements ITestListener {
    ...
    public void onTestSuccess(ITestResult result) {
        System.out.println("onTestSuccess= Sadece PASS olan @Test'lerden SONRA bir kere cagirilir: " + result.getName());
    }

    @Override
    public void onTestFailure(ITestResult result) {
        System.out.println("onTestFailure= Sadece FAIL olan @Test'lerden SONRA bir kere cagirilir: " + result.getName());
        try {
    ...
    public void onTestSkipped(ITestResult result) {
        System.out.println("onTestSkipped= Sadece SKIP(atlanan) @Test'lerden SONRA bir kere cagirilir: " + result.getName());
    }
